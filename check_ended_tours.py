...
def check_artist_upcoming(artist: str, api_key: str) -> dict:
    ...
    'error': str|None} for a single artist name.
    """
    params = {
        "apikey": api_key,
        "keyword": artist,
    ...
    try:
        ...
        next_date = events[0].get("dates", {}).get("start", {}).get("localDate")
        return {"found": True, "upcoming_count": total, "next_date": next_date, "error": None}
