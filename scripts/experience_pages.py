...
def home_page(head, schema):
    ...
    return head('Concerto | Everything After the Ticket, in One Place','Save your show. Concerto keeps the venue rules, setlist, timing, places nearby, and the plan for getting there and home together.','/',schema)+'<main class="experience-home">'+hero+statement+pillars+how+night+plus+grid+proof+close()+'</main>'+page_end()
