...
def ui_getting_out(slug):
    ...
    return ('<div class="ui ui-exit" aria-label="Getting Home card as it appears in the app"><span class="ui-kicker">Encore exit</span><h3>Getting Out</h3><p>'+esc(rs.get('note') or rs.get('summary'))+'</p><div class="ui-pills"><span>Uber</span><span>Lyft</span></div></div>')
...
home=head('Concerto | Live Music Near You Tonight, and Everything Around the Show','Shows near you tonight and this week, verified venue guides for 346 venues, 158 tours with live setlists, and Your Night, the plan for everything around the concert.','/',home_ld)+f'''<main>
