...
<section class="section partner-band"><div class="shell split"><div><p class="eyebrow">Concerto Partners</p><h2>Built with the places around the show.</h2></div><div><p class="lead">Restaurants, hotels, venues, and artists create real fan benefits, and Concerto places them where the night is being planned. Perks are always labeled. Concerto Picks stay editorial.</p><div class="hero-actions"><a class="btn-secondary" href="/partners">Partner with Concerto</a><a class="btn-secondary" href="/perks">See Concerto Perks</a></div></div></div></section>
