...
from public_chrome import header_html, page_end, HEAD_ASSETS, product_screen, photo_slot, app_link, smart_banner
...
home=head('Concerto | Live Music Near You Tonight, and Everything Around the Show','Shows near you tonight and this week, verified venue guides for {len(venues)} venues, {len(tours)} tours with live setlists, and Your Night, the plan for everything around the concert.','/',home_ld)+f'''<main>
