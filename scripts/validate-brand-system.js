...
for(const file of ['index.html','your-night.html','premium.html','partners.html','about.html']){
 ...
 if(page.includes('/img/product/')) fail.push(file+': screenshot reference present');
...
console.log('PASS: native brand alignment - app fonts and palette, one public stylesheet, screenshot-free product presentation');
