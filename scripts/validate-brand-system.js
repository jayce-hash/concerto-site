...
if(!standards.includes('Website revision — September 2026')) fail.push('current website standards missing');
...
console.log('PASS: editorial website standards - shared brand colors, one public stylesheet, unframed product captures');
